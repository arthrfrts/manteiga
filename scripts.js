window.addEventListener("DOMContentLoaded", function() {
  const footerHeight = document.querySelector('footer.colophon').offsetHeight;
  let contentElement = document.querySelector('main.easel');
...
(function() {
  ...
  isVideo = /(youtube)|(vimeo)|(cloudup)|(spotify)|(serialpodcast)|(twitch)|(stownpodcast)|(tumblr)|(txmblr)|(tmblr)/i;
